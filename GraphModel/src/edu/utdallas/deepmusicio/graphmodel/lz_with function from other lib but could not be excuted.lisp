...
;;;(defparameter *om-black-color* (make-instance 'omcolor :c (nil)))
...
(defclas simple-container ()
  ((parent :initform nil)
   ...
   (mus-color :initform nil);*om-black-color*
...
(defclass score-element (container analyse-object object-in-box) () )
(defclass sequence* (score-element) () )
                   ...
                   do (loop for note in chord
                            ...
                            do (progn
                             ...
                             (progn
                               ...
                               ;(print listonsets)
                               ;(print velocity)
                               (print (om* 100 (reverse chords)))
                               (print (om-round (reverse listonsets) 0 (/ 1.0 tcoef)))
                               (print (om-round (reverse durs) 0 (/ 1.0 tcoef)))
                               (print (reverse channels))
